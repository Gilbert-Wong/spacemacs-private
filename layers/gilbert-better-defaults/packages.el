...
(defun gilbert-better-defaults/init-dired-mode ()
  (use-package dired-mode
    ...
    (progn
      ...
      (evilified-state-evilify-map dired-mode-map
        :mode dired-mode
        :bindings
        (kbd "C-k") 'gilbert/dired-up-directory
        ...
        "J" 'counsel-find-file
        "f" 'gilbert/open-file-with-projectile-or-counsel-git
        ")" 'dired-omit-mode)
      )))


(defun gilbert-better-defaults/init-profiler ()
